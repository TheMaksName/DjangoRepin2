...
def registration_true(request):
    ...
    print(request.POST.get('school_name'))
    print(request.POST.get('phone'))
    print(request.POST.get('mentor_last_name'))
    print(request.POST.get('mentor_first_name'))
    print(request.POST.get('mentor_middle_name'))
    print(request.POST.get('mentor_position'))
    print(request.POST.get('team'))
    print(request.POST.get('custom_team'))
    ...
    #     print(1, team_option)
    #     print(2 ,request.POST.get('custom_team'))
